...
export function fetchUpcomingMovies(startDate, endDate, page) {
    const upcomingMoviesEndpointUrl = `https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=${page}&primary_release_year=2024&primary_release_date.gte=${startDate}&primary_release_date.lte=${endDate}&region=US&sort_by=popularity.desc`;
